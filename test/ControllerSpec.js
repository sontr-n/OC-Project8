...
describe('controller', function () {
	...
	describe('toggle all', function () {
		...
		it('should toggle all todos to completed', function () {
			...
			expect(model.update).toHaveBeenCalledWith(100, {completed: true}, jasmine.any(Function));
			expect(model.update).toHaveBeenCalledWith(101, {completed: true}, jasmine.any(Function));
		});
		...
		it('should update the view', function () {
			...
			expect(view.render).toHaveBeenCalledWith('elementComplete', {id: 100, completed: false});
		});
	});
	...
	describe('element removal', function () {
		...
		it('should remove an entry from the model', function () {
			...
			subject.setView('');
			view.trigger('itemRemove', {id: 100});
